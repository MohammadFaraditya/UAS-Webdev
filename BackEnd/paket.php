    ...
    <div class="card shadow mb-4">
        ...
        if (isset($_POST['Simpan'])) {
            ...
            if (($ekstensifile == "jpg") or ($ekstensifile == "JPG")) {
                ...
                mysqli_query($connection, "insert into paket value ('$paketid','$namapaket','$name','$tglmulai','$tglakhir','$hotel','$tiketpesawat','$transport','$harga')");
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                        <h1 class="display-4">Input Paket Wisata</h1>
                    </div>
                </div>
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="kodefoto" name="inputid" placeholder="ID Paket" maxlength="5">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="namafoto" name="inputnama" placeholder="Nama Paket">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="tglmulai" name="tglmulai" placeholder="Tanggal Mulai" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="tglakhir" name="tglakhir" placeholder="Tanggal Akhir" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="tiket" name="tiket" placeholder="ya atau tidak" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input class="form-control" id="harga" name="harga" placeholder="masukan harga" autocomplete="off">
                        </div>
                    </div>
