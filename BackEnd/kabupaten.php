...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($connection, "insert into kabupaten values ('$kabupatenID','$provinsiid','$kabupatennama','$kabupatentgl')");
    ...
    <div class="col-sm-10">
        ...
        <form method="POST">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodedestinasi" name="inputID" placeholder="ID Kabupaten" maxlength="4">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="namadestinasi" name="inputnama" placeholder="Nama Kabupaten">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" id="kbtTgl" name="kbtTgl" placeholder="Tanggal Berdirinya kabupaten" autocomplete="off">
                </div>
            </div>
