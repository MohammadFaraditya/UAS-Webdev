...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($connection, "insert into kecamatan values ('$kecamatanID','$provinsiid','$kabupatenid','$kecamatannama','$kecamatantgl')");
    ...
    <div class="col-sm-10">
        ...
        <form method="POST">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodekecamatan" name="inputID" placeholder="ID Kecamatan" maxlength="4">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="namakecamatan" name="inputnama" placeholder="Nama Kecamatan">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input class="form-control" id="kcmtTgl" name="kcmtTgl" placeholder="Tanggal Berdirinya Kecamatan" autocomplete="off">
                </div>
            </div>
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="kecamatannedit.php?ubah=<?php echo $row['kecamatanID'] ?>" class="btn btn-success btn-sm" title="Edit">
                        ...
                        <td>
                            <a href="kecamatanhapus.php?hapus=<?php echo $row['kecamatanID'] ?>" class="btn btn-danger btn-sm" title="Delete">
