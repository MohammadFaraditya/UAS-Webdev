...
if (isset($_POST['Edit'])) {
    ...
    mysqli_query($connection, "update area set areaNama = '$areanama', areaWilayah = '$areawilayah', areaKeterangan = '$areaket', provinsiID = '$provinsiid' where areaID ='$areakode'");
...
$editprovinsi = mysqli_query($connection, "select * from area, provinsi where areaID = '$kodearea'
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Input Area dan Provinsi</h1>
                </div>
            </div>
            <form method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="area" name="areaWilayah" value="<?php echo $rowedit['areaWilayah'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="areaKet" name="areaKet" value="<?php echo $rowedit['areaKeterangan'] ?>">
                    </div>
                </div>
