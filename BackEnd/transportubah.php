    ...
    <div class="card shadow mb-4">
        ...
        if (isset($_POST['Edit'])) {
            ...
            if (($ekstensifile == "jpg") or ($ekstensifile == "JPG")) {
                ...
                mysqli_query($connection, "update transport set namaKendaraan = '$namatransport', fotoKendaraan = '$name' where transportID = '$transportid'");
                header("location: transport.php");
            }
        }

        $kodetransport = $_GET["ubah"];
        $edittransport = mysqli_query($connection, "select * from transport
            ...
            <div class="col-sm-10">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="kodefoto" name="inputid" value="<?php echo $rowedit["transportID"]?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="namafoto" name="inputnama" value="<?php echo $rowedit["namaKendaraan"]?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <img src="images/<?php echo $rowedit['fotoKendaraan']?>" style="width: 200px; height: 100px;">
