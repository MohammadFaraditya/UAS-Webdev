...
if (isset($_POST['Edit'])) {
    ...
    mysqli_query($connection, "update provinsi set provinsiNama = '$provnama',provinsiTglBerdiri = '$provtgl' where provinsiID = '$provID'");
        ...
        <div class="col-sm-10">
            ...
            <form method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="provID" name="provID" value="<?php echo $rowedit['provinsiID'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="provNama" name="provNama" value="<?php echo $rowedit['provinsiNama'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input class="form-control" id="provTgl" name="provTgl" value="<?php echo $rowedit['provinsiTglBerdiri'] ?>">
                    </div>
                </div>
