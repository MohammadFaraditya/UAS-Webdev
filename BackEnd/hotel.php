    ...
    <div class="card shadow mb-4">
        ...
        if (isset($_POST['Simpan'])) {
            ...
            if (($ekstensifile == "jpg") or ($ekstensifile == "JPG")) {
                ...
                mysqli_query($connection, "insert into hotel value ('$hotelid','$namahotel',
                '$bintanghotel','$alamathotel','$provinsiid','$notelp','$name')");
            ...
            <div class="col-sm-10">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="kodefoto" name="inputid" placeholder="ID Hotel" maxlength="5">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="namafoto" name="inputnama" placeholder="Nama Hotel">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="bintang" name="inputbintang" placeholder="Bintang Hotel">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="telepon" name="telepon" placeholder="No Telepon Hotel">
                        </div>
                    </div>
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_array($query)) {  ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hotelubah.php?ubah=<?php echo $row['hotelID'] ?>" class="btn btn-success btn-sm" title="EDIT">
                                ...
                                <td>
                                    <a href="hotelhapus.php?hapus=<?php echo $row['hotelID'] ?>" class="btn btn-danger btn-sm" title="HAPUS">
