...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="../FRONTEND/images/hotel2.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="../FRONTEND/images/kamar2.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="../FRONTEND/images/pemandangan2.jpg" alt="Third slide">
    </div>
  </div>
  ...
  <div class="container">
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
      <h1 class="display-4"><?php echo $row_query2["namaHotel"] ?></h1>
      <br>
      Bintang <?php echo $row_query2["bintangHotel"] ?>
      <?php $dataprovinsi = mysqli_query($connection,"select * from provinsi where provinsiID = 'PV02'");
       $row_query5 = mysqli_fetch_array($dataprovinsi);
      ?>
      <h5>Alamat : <?php echo $row_query2["alamat"]?>, <?php echo $row_query5["provinsiNama"]?></h5>
      <br>
      <br>
    ...
    <div class="row">
      ...
      <div class="jumbotron jumbotron-fluid">
          <div class="container">
            ...
            <h1 class="display-4">Rp. 700.000</h1>
          </div>
        </div>
      </div>
