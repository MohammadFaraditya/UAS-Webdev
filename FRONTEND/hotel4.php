...
<body>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a class="dropdown-item" href="hotel1.php?ubah=<?php echo $row_query2['hotelID'] ?>"><?php echo $row_query2["namaHotel"] ?></a>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="../FRONTEND/images/hotel1.jpg" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="../FRONTEND/images/kamar4.jpg" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="../FRONTEND/images/pemandangan4.jp.jpg" alt="Third slide">
    </div>
  </div>
  ...
  <div class="container">
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
      <h1 class="display-4"><?php echo $row_query4["namaHotel"] ?></h1>
      <br>
      Bintang <?php echo $row_query4["bintangHotel"] ?>
      <?php $dataprovinsi = mysqli_query($connection,"select * from provinsi where provinsiID = 'PV03'");
       $row_query5 = mysqli_fetch_array($dataprovinsi);
      ?>
      <h5>Alamat : <?php echo $row_query4["alamat"]?>, <?php echo $row_query5["provinsiNama"]?></h5>
      <br>
      <br>
    ...
    <div class="row">
      ...
      <div class="jumbotron jumbotron-fluid">
          <div class="container">
            ...
            <h1 class="display-4">Rp. 1.000.000</h1>
          </div>
        </div>
      </div>
